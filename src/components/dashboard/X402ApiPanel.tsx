    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-lg font-bold mb-2">
              HTTP 402 Payment Protocol (L402)
            </h3>
            <p className="text-sm text-muted-foreground mb-4">
              The x402 protocol enables micropayments for API calls using the
              Lightning Network. Instead of subscriptions or rate limits, users
              pay tiny amounts per request.
            </p>
            ...
            <div className="flex items-center gap-2 text-xs text-purple-700">
              ...
              <span>
                Based on L402 (formerly LSAT) standard used by Lightning Labs
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl border border-border p-6">
        ...
        <div className="space-y-3">
          <div className="flex gap-3">
            <div className="w-8 h-8 rounded-full bg-orange-100 text-primary flex items-center justify-center text-sm font-bold">
              1
            </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground mt-1">
                Payment settles in ~390ms on Creditcoin Network
              </div>
            </div>
          </div>
        ...
        {apiKeys && apiKeys.length > 0 ? (
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted-foreground space-x-3">
                    ...
                    <span>•</span>
                    <span>
                      {key.usageToday}/{key.rateLimit} requests today
                    </span>
                    <span>•</span>
                    <span
                      className={cn(
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-xs mt-1">
              Create your first key to start using x402 payments
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-gray-900 text-green-400 p-6 rounded-xl font-mono text-sm">
        <div className="opacity-60 mb-4">
          # Example: Using x402 API with JavaScript
        </div>
      ...
      <div className="p-4 bg-green-50 border border-green-200 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-green-900">
            ...
            <p className="mb-2">
              Creditcoin Network has partnered with Coinbase to bring x402
              protocol to life! This is NOT just a demo - it's a working
              implementation.
            </p>
