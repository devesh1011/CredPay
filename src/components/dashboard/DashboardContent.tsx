      ...
      <div className="mt-8 p-4 bg-orange-50 border border-orange-200 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-orange-900">
            ...
            <p>
              The AI Payment Assistant demonstrates what is currently possible
              with existing technology. B2B and x402 API payments require
              additional smart contract infrastructure and are shown as
