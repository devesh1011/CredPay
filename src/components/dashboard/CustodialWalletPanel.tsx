...
export function CustodialWalletPanel() {
  ...
  const [activeTab, setActiveTab] = useState<"wallets" | "create" | "import">(
    "wallets"
  );
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Create secure wallets that can be controlled by AI agents. Private
              keys are encrypted client-side with military-grade AES-256-GCM
              encryption.
            </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-green-800 mb-3">
                        Save your recovery phrase securely. You will need it to
                        recover your wallet.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-orange-800 mt-2">
                        Never share this phrase. Anyone with it can access your
                        wallet.
                      </p>
                    </div>
                  </div>
            ...
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-yellow-900">
                  ...
                  <p>
                    Only import wallets you trust. Never share your private key
                    with anyone.
                  </p>
                </div>
              </div>
