    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-blue-900 mb-2">
                CreditcoinAtlantic-2 Testnet Mode
              </p>
              <div className="space-y-2 text-sm text-blue-800">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <Button variant="outline" size="sm" asChild>
                    <a
                      href={TESTNET_RESOURCES.creditcoinFaucet}
                      target="_blank"
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <CurrencyCircleDollarIcon size={16} weight="duotone" />
                      Get Test USDC
                    </a>
                  </Button>
                </div>
      ...
      <div className="bg-white rounded-xl border border-border p-6">
        <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
          <CpuIcon weight="duotone" size={24} className="text-primary" />
          Live x402 Demo{" "}
          {isTestnet() && (
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
        <h4 className="font-semibold mb-4 flex items-center gap-2">
          <CircuitryIcon weight="duotone" size={20} className="text-blue-600" />
          How This Demo Works
        </h4>
        ...
        <ol className="space-y-3 text-sm">
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong>402 Response:</strong> Server returns payment requirements
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong>Payment:</strong> Client sends USDC on Creditcoin Network
          ...
          <li className="flex gap-3">
            ...
            <div>
              <strong>Retry with Proof:</strong> Client retries with transaction
              hash as payment proof
            </div>
          </li>
          <li className="flex gap-3">
            ...
            <div>
              <strong>Access Granted:</strong> Server validates payment and
      ...
      <div className="p-4 bg-orange-50 border border-orange-200 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-orange-900">
            ...
            <p>
              This demo shows the actual x402 flow using Creditcoin Network and
              USDC. In production:
            </p>
            <ul className="mt-2 space-y-1 list-disc list-inside">
              <li>Payments would use USDC token contract on Sei</li>
              <li>
                Server would verify on-chain payment before granting access
              </li>
              <li>
                Client would use x402-fetch for automatic payment handling
              </li>
