            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground">
                  Transfer funds instantly to any wallet address on Creditcoin
                  Network. Fast, secure, and with zero fees.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      All transactions are recorded on the blockchain for full
                      transparency
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Send payments anytime, anywhere. No bank holidays or
                      closing hours
                    </p>
                  </div>
                </div>
