// x402 Protocol Configuration for Creditcoin Network

// USDC Contract Addresses
export const USDC_CONTRACTS = {
  mainnet: {
    address: "0x3894085Ef7Ff0f0aeDf52E2A2704928d1Ec074F1", // USDC on CreditcoinMainnet
    decimals: 6,
    symbol: "USDC",
  },
  testnet: {
    address: "0x4fCF1784B31630811181f670Aea7A7bEF803eaED", // USDC on CreditcoinAtlantic-2 Testnet
    decimals: 6,
    symbol: "USDC",
  },
} as const;
...
export const getCurrentX402Config = () => {
  ...
  return isMainnet
    ? X402_CONFIG.networks.mainnet
    : X402_CONFIG.networks.testnet;
};
...
export const getTestnetWarning = () => {
  ...
  return {
    message: "You are on CreditcoinAtlantic-2 Testnet",
    details: [
      "Using testnet USDC (no real value)",
      "Get test Creditcoinfrom the faucet for gas fees",
